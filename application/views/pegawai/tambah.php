              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="role" value="Admin" id="exampleRadios3" <?= set_value('role') == 'Admin' ? 'checked' : '' ; ?> >
                    <label class="form-check-label" for="exampleRadios3">
                      Admin
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="role" value="Owner" id="exampleRadios4" <?= set_value('role') == 'Owner' ? 'checked' : '' ; ?> >
