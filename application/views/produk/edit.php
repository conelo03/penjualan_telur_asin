              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    ...
                    <input type="number" name="stok_produk" class="form-control" value="<?= set_value('stok_produk', $produk['stok_produk']); ?>" required="">
                    <?= form_error('stok_produk', '<span class="text-danger small">', '</span>'); ?>
                  </div>
                  <div class="col-md-3 form-group">
                    <label>Harga Produk</label>
                    <input type="number" name="harga_produk" class="form-control" value="<?= set_value('harga_produk', $produk['harga_produk']); ?>" required="">
                    <?= form_error('harga_produk', '<span class="text-danger small">', '</span>'); ?>
                  </div>
                </div>
                <div class="form-group">
                  <label>Deskripsi Produk</label>
                  <textarea type="text" name="deskripsi_produk" class="form-control" required=""><?= set_value('deskripsi_produk', str_replace('<br />', '', $produk['deskripsi_produk'])); ?></textarea>
                  <?= form_error('deskripsi_produk', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="row">
                  <div class="col-md-12 form-group">
                    <label>Foto Produk</label>
                    <input type="hidden" name="foto_produk_old" value="<?= $produk['foto_produk'] ?>" />
